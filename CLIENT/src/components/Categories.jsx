...
const Categories = () => {
    ...
    return (
        <div className='w-[95%] h-[30rem] md:h-[24rem] lg:h-[25rem] mx-auto mt-12 flex flex-col  border-t border-t-gray-200 border-b border-b-gray-200'>
            ...
            <div className='flex flex-wrap md:flex-nowrap gap-4 w-full h-[70%] mt-5  items-center lg:justify-center lg:gap-10'>
