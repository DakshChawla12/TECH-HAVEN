...
const SingleProductPage = () => {
    ...
    return (
        <>
            <div className='w-[85%] h-[35rem] mt-16 mx-auto flex flex-col gap-5 justify-between md:flex-row border-2'>
                <div className='w-[100%] md:w-[55%] h-[45%] md:h-[100%] flex flex-col justify-evenly items-center md:flex-row-reverse'>
                    ...
                    <div className='w-[100%] h-[25%] md:h-[80%] md:w-[25%] flex justify-around md:flex-col'>
                        <div className='w-[18%] h-[100%] md:w-[100%] md:h-[18%] xl:w-[80%] xl:h-[19%] mx-auto' onClick={() => changeImage(0)}>
                            <img src={product.images[0]} alt="" className='h-[100%] w-[100%]' />
                        </div>
                        <div className='w-[18%] h-[100%] md:w-[100%] md:h-[18%] xl:w-[80%] xl:h-[19%] mx-auto' onClick={() => changeImage(1)}>
                            <img src={product.images[1]} alt="" className='h-[100%] w-[100%]' />
                        </div>
                        <div className='w-[18%] h-[100%] md:w-[100%] md:h-[18%] xl:w-[80%] xl:h-[19%] mx-auto' onClick={() => changeImage(2)}>
                            <img src={product.images[2]} alt="" className='h-[100%] w-[100%]' />
                        </div>
                        <div className='w-[18%] h-[100%] md:w-[100%] md:h-[18%] xl:w-[80%] xl:h-[19%] mx-auto' onClick={() => changeImage(3)}>
                            <img src={product.images[3]} alt="" className='h-[100%] w-[100%]' />
                        </div>
                        <div className='w-[18%] h-[100%] md:w-[100%] md:h-[18%] xl:w-[80%] xl:h-[19%] mx-auto' onClick={() => changeImage(4)}>
            ...
            <div className='mx-auto h-[12rem] w-[85%] border-2 flex items-center justify-center'>
                {product.reviews.map((review) => {
                    return <div className='h-[90%] w-[25%] border-2 flex flex-col justify-center gap-3'>
